...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/PLAYGAMA_0.1.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/PLAYGAMA_0.1.data.unityweb',
                        frameworkUrl: 'Build/PLAYGAMA_0.1.framework.js.unityweb',
                        codeUrl: 'Build/PLAYGAMA_0.1.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'AM',
                        productName: 'Dress Up 3D',
                        productVersion: '0.1',
