...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/gametest.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/gametest.data.unityweb',
                        frameworkUrl: 'Build/gametest.framework.js.unityweb',
                        codeUrl: 'Build/gametest.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'John Hany',
                        productName: 'Obby Survival',
                        productVersion: '1',
